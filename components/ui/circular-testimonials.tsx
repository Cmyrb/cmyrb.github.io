        ...
        >
          {testimonials.map((testimonial, index) => (
            <img
              ...
              className="absolute w-full h-full object-cover rounded-2xl shadow-[0_10px_30px_rgba(0,0,0,0.5)]"
        ...
        <div className="flex flex-col justify-between">
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <p className="mb-6" style={{ color: colorDesignation, fontSize: fontSizeDesignation }}>
                {activeTestimonial.designation}
              </p>
             <div className="leading-relaxed" style={{ color: colorTestimony, fontSize: fontSizeQuote }}>
  {activeTestimonial.quote.split("|").map((part, i) => (
    <motion.p
      key={i}
      className={i > 0 ? "mt-3" : ""}
